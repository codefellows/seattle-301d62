...
//  "this" refers to the "function" call. When invoking a new Object, this refers to that constructor function through the "function" call. 
// 2. What is "this" when joe.scopeArrow() is invoked?
//  "this" doesnt refer to anything. THats why it comes back as undefined. The arrow function doesn't mix well with Constructor functions
// 3. Explain why "this" is different when an arrow function is used.
//  I'm not sure why its happening. All I know is that constructor functions dont operate with arrow functions when the term "this" is used.
