...
// "this" refers to joe when scope() is invoked.
// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" instead refers to the window object of the page.
// 3. Explain why "this" is different when an arrow function is used.
// "this" is dependent on the function surrounding the "this" keyword. In the case of scope(), this is enclosed in a method of Student. In the case of scopeArrow(), it is not enclosed in a function, but it is enclosed in the window object of the webpage, so "this" refers to the webpage.
