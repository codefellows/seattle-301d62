...
function displayPics(){
  ...
  // DONE: In a sentence or two, explain why the previous line of code threw an error when we changed the constiable declaration from `var to `const`.
  // rando is defined with `const` inside of the `while` block that concludes before the call was made to reference `rando`
  console.log(viewed);
